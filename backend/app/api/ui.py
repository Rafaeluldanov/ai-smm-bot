...
def ui_project_chief_of_staff(project_id: int) -> HTMLResponse:
    ...
    script = (
        ...
        "async function loadDecisions(){const d=await api('GET','/projects/'+PID+'/decisions');"
        ...
        "await api('POST','/projects/'+PID+'/decisions',{decision_type:document.getElementById('ch-dtype').value,"
