...
# Типы usage для AI Strategy Simulator (v0.7.5). Прогнозы/сравнения — бесплатно (0 units).
...
# Типы usage для AI Business Planner (v0.7.7). План/roadmap — бесплатно (0 units).
...
# Типы usage для AI Continuous Improvement (v0.8.0). Обучение/отчёт — бесплатно (0 units).
USAGE_LEARNING_ANALYSIS = "learning_analysis"
USAGE_LEARNING_REPORT = "learning_report"

# Типы usage для AI Autonomous Optimization (v0.8.1). Оценка/отчёт — бесплатно (0 units).
...
# Типы usage для AI Business OS Pilot (v0.9.1). Pilot-анализ/отчёт — бесплатно (0 units).
