...
Workflow очистки медиатеки (duplicate review, approved retagging, скрытие дублей без удаления)
реализован в [45](45_Botfleet_Media_Curation_Workflow.md) (v0.4.8). Далее: image embeddings
(визуальная релевантность/near-dup по содержимому) · визуальная AI-модель качества · video
fingerprinting · реальный duplicate cleanup с бэкапами.
