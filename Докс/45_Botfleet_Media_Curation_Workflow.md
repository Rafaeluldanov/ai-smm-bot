...
> **Продолжение (v0.4.9):** collaborative review реализован — задачи на проверку,
> ответственные, комментарии, история решений и **approve-before-apply**. См.
> [46_Botfleet_Media_Curation_Review.md](46_Botfleet_Media_Curation_Review.md). Прямой apply
> из v0.4.8 теперь тоже уважает согласование при `MEDIA_CURATION_REVIEW_REQUIRE_APPROVAL=true`.
