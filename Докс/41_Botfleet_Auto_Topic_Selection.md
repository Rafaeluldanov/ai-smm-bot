...
Авто-выбор медиа-стратегии реализован в
[42](42_Botfleet_Auto_Media_Selection.md) (v0.4.5). Далее: multi-armed bandit / Bayesian
оптимизация · сезонное планирование · content-gap crawler · платформенно-специфичное
взвешивание метрик · production live-auto аудит.
