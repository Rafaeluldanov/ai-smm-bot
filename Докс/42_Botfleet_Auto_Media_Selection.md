...
`diversity_score`) — в [44](44_Botfleet_Media_Fingerprints_Dedup.md) (v0.4.7). Далее:
автосоздание публичных ссылок после публичного HTTPS-домена · image embeddings · полноценная
