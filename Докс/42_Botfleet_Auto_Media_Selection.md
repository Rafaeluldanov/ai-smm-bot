...
Оценка качества медиа и дедупликация реализованы в
[43](43_Botfleet_Media_Quality_Scoring.md) (v0.4.6). Далее: автосоздание публичных ссылок
после публичного HTTPS-домена · image embeddings (визуальная релевантность) · полноценная
video-стратегия · платформенно-специфичное взвешивание медиа-метрик · production live-auto
аудит.
