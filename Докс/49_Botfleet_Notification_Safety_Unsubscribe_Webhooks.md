...
> **Реализовано в v0.5.3:** email-шаблоны с футером отписки (токен из этого unsubscribe-сервиса,
> маскируется в preview/логах) и SMTP live-ready foundation (по умолчанию отказывает). См.
> [50_Botfleet_Email_Templates_SMTP_Sandbox.md](50_Botfleet_Email_Templates_SMTP_Sandbox.md).
>
> **Реализовано в v0.5.4:** Telegram-канал уведомлений уважает все эти safety-гейты
> (opt-out/rate-limit/suppression/preferences) плюс требует **verified binding**; реальная
> Telegram-доставка выключена по умолчанию. См.
