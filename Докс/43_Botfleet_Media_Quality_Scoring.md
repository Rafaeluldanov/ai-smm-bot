...
Визуальная дедупликация по fingerprint/perceptual hash реализована в
[44](44_Botfleet_Media_Fingerprints_Dedup.md) (v0.4.7), а workflow очистки/разметки медиатеки
(скрытые медиа → issue `hidden_from_selection` и низкий overall) — в
[45](45_Botfleet_Media_Curation_Workflow.md) (v0.4.8). Далее: image embeddings · визуальная
AI-модель качества · оценка видео · production live-auto аудит.
